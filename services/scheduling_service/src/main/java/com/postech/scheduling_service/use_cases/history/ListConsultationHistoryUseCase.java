...
public class ListConsultationHistoryUseCase implements UseCase<Void, List<ConsultationDto>> {
    private final HistoryClient historyClient;

    @Override public List<ConsultationDto> execute(Void ignore) {
        return historyClient.listConsultationHistory();
    }
}
